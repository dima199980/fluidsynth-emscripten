...
void fluid_synth_settings(fluid_settings_t *settings)
{
    ...
    fluid_settings_register_int(settings, "synth.songsterr-track-audio", 0, 0, 1, FLUID_HINT_TOGGLED);
...
new_fluid_synth(fluid_settings_t *settings)
{
    ...
    fluid_settings_getint(settings, "synth.songsterr-track-audio", &synth->songsterr_track_audio);
